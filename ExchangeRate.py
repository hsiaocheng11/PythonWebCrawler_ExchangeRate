...
while True:
    try:
        ...
        if (option == "1"):
            ...
            #line1.dLbls.showVal = True #顯示數據標籤
            
            line1.trendline = Trendline(spPr=GraphicalProperties(ln=LineProperties(w=40000, prstDash='sysDot', solidFill='5082BE'))) #加入趨勢線
            ...
            filename = 'ExchangeRate('+currencyId+')'+date_time_string+'.xlsx'
